...
public class LanguageCoreTest {
  ...
  public static Stream<Arguments> remappingIso639_2() {
    return Stream.of(Arguments.of(BOKMAAL, "nor"), Arguments.of(MULTIPLE, "mis"));
  }
  ...
  public static Stream<Arguments> remappingEnglish() {
    return Stream.of(
        Arguments.of(BOKMAAL, "norwegian"), Arguments.of(MULTIPLE, "miscellaneous language"));
  }

  public static Stream<Arguments> remappingBokmaal() {
    return Stream.of(Arguments.of(BOKMAAL, "norsk"), Arguments.of(MULTIPLE, "annet språk"));
  }

  public static Stream<Arguments> remappingNynorsk() {
    return Stream.of(Arguments.of(BOKMAAL, "norsk"), Arguments.of(MULTIPLE, "anna språk"));
  }
}
