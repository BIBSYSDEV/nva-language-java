...
public final class LanguageMapper {
    ...
    public static Language getLanguageByIso6391Code(String code) {
        return (Language) mappedValue(ALL_LANGUAGES.stream().filter(language -> convertString(code)
                .equalsIgnoreCase(language.getIso6391Code())));
    }

    public static Language getLanguageByIso6392Code(String code) {
        return (Language) mappedValue(ALL_LANGUAGES.stream().filter(language -> language.getIso6392Code().stream()
    ...
    public static LanguageDescription getLanguageByEnglishName(String name) {
        return mappedValue(ALL_LANGUAGES.stream().filter(language -> convertString(name)
    ...
    public static LanguageGroup getLanguageByIso6395Code(String iso6395Code) {
        return (LanguageGroup) mappedValue(ALL_LANGUAGES.stream()
    ...
    public static LanguageDescription getLanguageByPotentialIsoCode(String potentialIsoCode) {
        return mappedValue(ALL_LANGUAGES.stream().filter(language -> matchesCode(potentialIsoCode, language)));
    }
